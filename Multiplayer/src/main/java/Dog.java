...
public class Dog extends GameObject{
	...
	public Dog(float x, float y, ObjectId id, Assets assets, int i){
		super(x, y, id);
		this.i = i;
		falling = true;
		jumping = false;
		...
		dogIdle = new Animation(Constants.DOG_IDLE_ANIMATION,
			assets.getDogSpriteIdel()[0], assets.getDogSpriteIdel()[1],
			assets.getDogSpriteIdel()[2], assets.getDogSpriteIdel()[3],
			assets.getDogSpriteIdel()[4], assets.getDogSpriteIdel()[5]);
	...
	public void render(Graphics g){
			...
			/*if(facing == Facing.Left){
				dogIdle.drawAnimation(g, (int)x + Constants.DOG_RECTANGLE_WIDTH, 
					(int)y, - Constants.DOG_RECTANGLE_WIDTH, Constants.DOG_RECTANGLE_HEIGTH);
			}else{
				dogIdle.drawAnimation(g, (int)x, (int)y,
					Constants.DOG_RECTANGLE_WIDTH, Constants.DOG_RECTANGLE_HEIGTH);
			}*/
	...
	public Animation getAssets(){return dogIdle;}
